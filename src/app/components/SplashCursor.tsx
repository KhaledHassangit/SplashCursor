...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function initFramebuffers() {
      ...
      if (!rgba) {
        throw new Error("Required framebuffer format 'rgba' is not supported.");
      }
      if (!dye) {
        dye = createDoubleFBO(
          dyeRes.width,
      ...
      if (!rg) {
        throw new Error("Required framebuffer format 'rg' is not supported.");
      }
      if (!velocity) {
      ...
      if (!r) {
        throw new Error("Required framebuffer format 'r' is not supported.");
      }
